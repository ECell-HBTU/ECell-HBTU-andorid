...
public class CardContainerView extends FrameLayout {
    ...
    private void updateAlpha() {
        ...
        if (option.swipeDirection.equals(SwipeDirection.HORIZONTAL)) {
            showHorizontalOverlay(percentX);
        } else if (option.swipeDirection.equals(SwipeDirection.VERTICAL)) {
            showVerticalOverlay(percentY);
        } else if (option.swipeDirection.equals(SwipeDirection.FREEDOM_NO_BOTTOM)) {
        ...
        } else if (option.swipeDirection.equals(SwipeDirection.FREEDOM)) {
