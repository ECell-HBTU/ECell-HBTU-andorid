...
public class EventsActivity extends AppCompatActivity {
    ...
    private void initializeData(){
        ...
        events.add(new Event("Pitching Workshop","12th Sept, 2018","10AM to 1PM",R.drawable.ic_launcher));
        events.add(new Event("Elevator Pitch","12th Sept, 2018","10AM to 1PM",R.drawable.ic_launcher));
        events.add(new Event("Start-up 101","12th Sept, 2018","10AM to 1PM",R.drawable.ic_launcher));
        events.add(new Event("Talk : 10 ways to gain investors attention!","12th Sept, 2018","10AM to 1PM",R.drawable.ic_launcher));
        events.add(new Event("Innovative Idea Competition","12th Sept, 2018","10AM to 1PM",R.drawable.ic_launcher));
        events.add(new Event("Start-up quiz","12th Sept, 2018","10AM to 1PM",R.drawable.ic_launcher));
